...
export default class Dashboard extends Component {
    ...
    render() {
        return (
            <div className="dashboard signed">
                {/* Container Citas */}
                ...
                <div className="container pt-3">
                    ...
                    {this.state.citasPaciente.length < 1 &&
                        <div className="d-flex justify-content-around mt-5  ">
                            <h1 className="text-black-50">No tienes citas solicitadas</h1>
                        </div>
                    }
                    <div className="row">
                        {/* //rendering citas */}
                                ...
                                <div className="card">
                                    ...
                                    <div className="card-footer align-items-center">
                                        <div className="d-flex justify-content-end">
                                            <button className="btn btn-danger" onClick={() => this.deleteCita(cita._id)}><i className="fas fa-trash-alt mr-1"></i>Cancelar Cita</button>
                                        </div>
                                    </div>
                                </div>
                            </div>)
